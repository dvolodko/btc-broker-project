...
//   }
// }
function(r){let d=r.getAttribute("data-state");d&&"closed"!==d?s():(e.classList.add("active"),c.classList.add("active"),a.classList.add("no-scroll"),n(t,"active"),e.addEventListener("click",o),document.addEventListener("keydown",i),t.setAttribute("data-state","opened"),t.setAttribute("aria-expanded","true"))}(t)});//# sourceMappingURL=index.0c87c388.js.map

//# sourceMappingURL=index.0c87c388.js.map
