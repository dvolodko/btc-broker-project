...
//   }
// }
function(d){let s=d.getAttribute("data-state");s&&"closed"!==s?n():(e.classList.add("active"),a.classList.add("active"),c.classList.add("no-scroll"),r(t,"active"),e.addEventListener("click",i),document.addEventListener("keydown",o),t.setAttribute("data-state","opened"),t.setAttribute("aria-expanded","true"))}(t)});const d=document.querySelectorAll(".accordion");d.forEach(e=>{e.addEventListener("click",e=>{let t=e.target.closest(".accordion-panel");t&&function(e){let t=e.querySelector("button"),a=e.querySelector(".accordion-content"),c=t.getAttribute("aria-expanded");"true"===c?(t.setAttribute("aria-expanded",!1),a.setAttribute("aria-hidden",!0)):(t.setAttribute("aria-expanded",!0),a.setAttribute("aria-hidden",!1))}//# sourceMappingURL=index.18ad435a.js.map
(t)})});
//# sourceMappingURL=index.18ad435a.js.map
